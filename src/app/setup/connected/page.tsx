      ...
      <div className="flex flex-col items-center justify-center space-y-5 text-center">
        ...
        <div style={{ animation: "fadeUp 0.4s ease 0.5s both" }}>
          ...
          <p className="text-white/40 text-sm mt-2">
            {cannotClose
              ? "You can close this tab and return to setup."
              : "Closing this tab..."}
          </p>
          {cannotClose && (
            <button
              onClick={() => window.close()}
              className="mt-4 inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-sm font-medium text-white transition-colors"
            >
